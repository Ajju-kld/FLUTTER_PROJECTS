  ...
  return Row(
    ...
    children: [
      ...
      obscuringCharacter: '*',
          ...
          style:const TextStyle(color: Colors.white, height: 25 / 20,fontSize: 20),
...
SizedBox btn_({void Function() ?onPressed,bool check=true,required String ?title}){
  return SizedBox(
                width: 270,
                height: 45,
               ...
               const   Color.fromARGB(114, 0, 162, 143)) ,
                     ...
                     const     Color.fromARGB(211, 0, 0, 0)),
                      shape: MaterialStateProperty.all(RoundedRectangleBorder(
                          ...
                          side: BorderSide(
                              width: 3,
                              color:check?const Color.fromARGB(218, 0, 162, 143):const Color.fromARGB(35, 0, 162, 143))))),
                  child:Text(
                    title!,
